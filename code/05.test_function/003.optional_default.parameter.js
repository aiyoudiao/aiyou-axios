...
// #region 可选参数 Code Module
{
  ...
  var result1 = buildName2 ('i');
  var result2 = buildName2 ('i', 'love jwl');
}
...
// #region 默认参数 Code Module
{
  ...
  var result1 = buildName3 ('i');
  /* 第二个参数的默认值，只有当没有传入数据或者传入undefined是才会生效 */
  var result2 = buildName3 ('i', undefined);
  var result3 = buildName3 ('i', 'love jwl');
}
...
// #region 剩余参数 Code Module
{
  ...
  var result1 = buildName4 ('i');
  var result2 = buildName4 ('i', 'love', 'jwl', ' day');
  console.log (result1);
  console.log (result2);
}
